...
jQuery(document).ready(function () {
    ...
    $('#input_text').on('keyup', function (e) {
        if (e.key == ' ') {
            $.ajax({
                ...
                $('#text_bartolomej').val(jsondata['bartolomej'])
                $('#text_slovakbert').val(jsondata['slovakbert'])
    ...
    $('#btn-process').on('click', function () {
        $.ajax({
            ...
            console.log(jsondata)
            $('#mask_text_bartolomej').val(jsondata['bartolomej'])
            $('#mask_text_slovakbert').val(jsondata['slovakbert'])
